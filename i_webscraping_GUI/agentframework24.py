...
class Agent:
    ...
    def breed(self, breed_with):
        """
        If we get here one partner is a ram and the other a ewe. The lambs will come into existence at the same
        ...
        number_of_lambs = random.choice([1, 1, 1, 1, 1, 2, 2, 2, 3, 0])  # random choice for number of lambs born
