...
for i in range(num_of_agents):
    ...
    agents.append(agentframework23.Agent(i, environment, agents, ram=ram, x=x, y=y))
...
def animate(frame_number):
    ...
    # Stopping Condition - when there are 25 agents
    ...
    if count == 50:  # count can be increased here to run model for longer
